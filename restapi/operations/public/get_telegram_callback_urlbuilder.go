...
func (o *GetTelegramCallbackURL) WithBasePath(bp string) *GetTelegramCallbackURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetTelegramCallbackURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetTelegramCallbackURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetTelegramCallbackURL")
	}
